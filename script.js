  ...
  function initContactForm() {
    ...
    form.addEventListener('submit', function(e) {
      ...
      .catch(function() {
        ...
        errorMsg.className = 'form-error form-global-error';
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: '564fd5f6-da6c-48a5-9ab7-cac41ce0405a',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '564fd5f6-da6c-48a5-9ab7-cac41ce0405a';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '564fd5f6-da6c-48a5-9ab7-cac41ce0405a';
